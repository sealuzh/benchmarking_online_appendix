#
# Cookbook Name:: jm-acmeair-default-double-peak-assets
# Recipe:: default
#
...
#insert the jmeter-plugins.jar
cookbook_file "#{jmeter_root_dir}/lib/ext/JMeterPlugins-Standard.jar" do
  source 'JMeterPlugins-Standard.jar'
  mode '0644'
  action :create
end

#insert the CMD_runner.jar
cookbook_file "#{jmeter_root_dir}/lib/ext/CMDRunner.jar" do
  source 'CMDRunner.jar'
  mode '0644'
  action :create
end
